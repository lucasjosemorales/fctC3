...
@Composable
fun AlertDialogEliminarProfesor(showDialog: MutableState<Boolean>)
{
    val viewModelProfesor: ProfesorViewModel = viewModel()
                ...
                confirmButton = {
                    ...
                    )
                    {
                        ...
                        Button(
                            ...
                            onClick = {
                                showDialog.value = false
                                viewModelProfesor.eliminarProfesor(firstInput)
                                viewModelProfesor.removeProfesorByEmail(firstInput)
                            },
                            enabled = loginEnable
                        ) {
                            Text("Confirmar")
